<%-- 
    Document   : BlankPage
    Created on : Aug 15, 2024, 10:03:19 PM
    Author     : xuant
--%>
...
<html>
    ...
    <body class="hold-transition skin-blue sidebar-mini">
            ...
            <aside class="main-sidebar">
                ...
                <section class="sidebar">
                    ...
                    <ul class="sidebar-menu">
                        ...
                        <li><a href="${pageContext.request.contextPath}/assets/documentation/index.html"><i class="fa fa-book"></i> <span>Documentation</span></a></li>
      ...
      <div class="box">
        <div class="box-header with-border">
          ...
          <td>
              <a href="addBrandname">
    <h3 class="btn btn-primary" style="margin-left: 1085px; font-size: 19px;">ADD</h3>
</a>
    ...
    <tr>
        ...
        <td>${o.description}</td>
        <td>
            <form action="deleteBrandname" method="post" style="display:inline;">
                <input type="hidden" name="id" value="${o.idBrandName}">

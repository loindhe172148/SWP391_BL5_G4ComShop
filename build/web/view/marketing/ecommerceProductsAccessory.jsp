<%-- 
    Document   : ecommerce-products-accessory
    Created on : Aug 8, 2024, 12:07:06 PM
    Author     : LENOVO
--%>
...
<head>
        <meta charset="utf-8" />
        <title>Ecommerce Products | Ubold - Responsive Bootstrap 5 Admin Dashboard</title>
                        ...
                        <li class="menu-item">
                            ...
                            <div class="collapse" id="menuEcommerce">
                                <ul class="sub-menu">
                                    ...
                                    <li class="menu-item">
                                        <a href="ecommerce-products-computer.html" class="menu-link">
                                            <span class="menu-text">Products Computer</span>
                                        </a>
                                    </li>
                                    <li class="menu-item">
                                    ...
                                    <li class="menu-item">
                                        <a href="ecommerce-product-edit.html" class="menu-link">
                                            <span class="menu-text">Add Product Accessory</span>
                                        </a>
                                    </li>
                                    <li class="menu-item">
                                                   ...
                                                   <div class="me-sm-3">
                                                       <select class="form-select my-1 my-lg-0" id="status-select" onchange="location = this.value;">
                                                           <c:forEach items="${listB}" var="o"> 
                                                               <option value="Bandname?idBrandName=${o.idBrandName}">${o.brandName}</option>
                                                           </c:forEach>
                                                       </select>
                                                   </div>
        ...
        <tbody>
            <c:forEach items="${listA}" var="o">
                <tr>
                    ...
                    <td>${o.name}</td>
                    <td>
                        <img style="height: 4em; width: auto;" src="${o.img}" class="img-fluid small-image" />
                    </td>
                    <td>${o.description}</td>
                    <td>${o.color}</td>
                    <td>${o.quantity}</td>
...
<td>
    <div class="text-center mb-3">
        ...
        <button type="button" class="btn w-sm btn-danger waves-effect waves-light"
            onclick="location.href='Delete?Aid=${o.id}'">Delete</button>
    </div>
</td>
    ...
    <div class="input-group">
        <input type="search" class="form-control rounded-pill" placeholder="Search..." id="top-search" name="txt">
